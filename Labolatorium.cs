...
{
    public partial class Labolatorium : Form
    {
        ...
        public Labolatorium()
        {
            ...
            mfPióro.DashStyle = DashStyle.Solid;

            mflbl1.Text = mftrbKątPochyleniaBryły.Value.ToString();
        ...
        private void Labolatorium_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }

        private void Labolatorium_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        {
            mflbl1.Text = mftrbWysokośćBryły.Value.ToString();
        }

        private void mftrbPromieńBryły_Scroll(object sender, EventArgs e)
        {
            mflbl2.Text = mftrbPromieńBryły.Value.ToString();
        }

        private void mftrbKątPochyleniaBryły_Scroll(object sender, EventArgs e)
        {
            mflbl3.Text = mftrbKątPochyleniaBryły.Value.ToString();
        }
